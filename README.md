...
- ![GPO Creation](screenshots/gpo-creation.png)
- ![Control Panel Disabled](screenshots/ControlPanelDisabled.png)(screenshots/ControlPanelDisabled2.png)
- ![Wallpaper Applied](screenshots/desktop-wallpaper.png)
